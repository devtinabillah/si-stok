	...
	<div class="container-fluid">
		...
		<div class="col-auto">
			...
			<div class="card my-3" id="form-permintaan" style="background-color: #00663d; width: 650px;">
				<div class="row my-2" style="color: white;">
					<div class="col-sm-8">
						<h5 class="card-header">Input Pengiriman Barang Masuk</h5>
					</div>
					<div class="col">
				...
				<div class="card-body" style="background-color: #e6ffee">
					...
					<div class="input-barang" style="background-color: #e6ffee">
		...
		<form action="<?= base_url('pembelian/pembelian/tambahPengiriman') ?>" method="POST" id="form-add">
			...
			<button type="submit" class="btn btn-success btn-block btn-submit mb-3">Kirim Barang</button>
		</form>
	</div>
