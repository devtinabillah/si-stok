...
<div class="card mt-3" >
  <h5 class="card-header" style="background-color: #00663d; color: white;">Daftar Permintaan Barang Keluar</h5>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="<?= base_url("pengiriman/pengiriman/terimaPermintaan/$value[id_permintaan]") ?>" class="btn btn-success btn-terima">Terima</a>
						<?php endif; ?>
					</td>
				</tr>
				<?php endforeach; ?>
